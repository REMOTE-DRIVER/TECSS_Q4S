    ...
    def measurement_send_message(self):
        ...
        while self.running:
            ...
            try:
                ...
                print(f"CLIENT: ERROR in sending message {e}")
                continue
        ...
        while retries < 3:
            try:
                ...
                if "ACK" in message_type:
                    ...
                    print("CLIENT: Respuesta invalida")
            except socket.timeout:
                retries+=1
                print(f"CLIENT: Timeout, reintentando {retries}/3")
        else:
            print("CLIENT: Error, no se puede conectar al servidor")
            return -1
...
if __name__=="__main__":
    ...
    q4s_node = q4s_lite_client(client_address, client_port, server_address, server_port)
    q4s_node.run()
    try:
        while True:
            #time.sleep(0.1)
